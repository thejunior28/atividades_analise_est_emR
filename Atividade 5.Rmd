...
2.  Considerando a pesquisa do exercício anterior, os níveis de colesterol de pacientes submetidos ao medicamento D foram avaliados e estão descritos abaixo.
    ...
    **Teste 1.: Shapiro-Wilk**
    ...
    -   **Hipóteses**:
        ...
        -   H_a: A amostra não provém de uma população com distribuição normal.
    ...
    **Teste 2.: Lilliefors**
    ...
    -   **Hipóteses**:
        ...
        -   H_a: O nível médio de colesterol dos pacientes é menor que 130 mg/dL.
...
3.  A secretaria municipal afirmou que no máximo 10% das residências possuem criadouros de dengue. Um levantamento foi realizado e foram encontrados criadouros de dengue em 42 de 596 residências visitadas.
    ...
    -   **Hipóteses**:
        ...
        -   H_a: A proporção de residências com criadouros é maior que 10% (a afirmação da secretaria é falsa).
    ...
    # Cálculo do tamanho do efeito
    efeito <- ES.h(p1 = 0.15, # p1 = proporção sob a hipótese alternativa que queremos detectar
...
O resultado indica que seriam necessárias aproximadamente 295 residências. Como o número de residências deve ser um valor inteiro, arredondamos para cima. Portanto, **num próximo levantamento, deverão ser avaliadas 296 residências** para ter um poder de 80% de detectar um aumento real na proporção de criadouros para 15%, com um nível de significância de 5%.
