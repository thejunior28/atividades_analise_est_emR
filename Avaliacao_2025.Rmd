...
c.  Há diferença do sexo e idade entre os grupos que receberam os diferentes medicamentos. Faça os testes de hipóteses com nível de significância de 0,05.
    ...
    Com nível de significância de 0,05, não se rejeita H0, ou seja, a proporção de homens e mulheres é a mesma nos dois grupos de tratamento.
    ...
    Com nível de significância de 0,05, não se rejeita H0, ou seja, a distribuição das idades é a mesma nos dois grupos.
...
b.  Com nível de significância de 0,05, avalie o objetivo da pesquisa.
    ...
    Com nível de significância de 0,05, rejeita-se H0. Isso significa que existem evidências estatísticas suficientes para afirmar que há uma diferença significativa na quantidade média de partículas suspensas entre pelo menos dois dos locais avaliados.
